...
@Singleton class CreateController @Inject()(val mcc: MessagesControllerComponents, view: create, textInputView: text_input)(implicit val executionContext: ExecutionContext) extends FrontendController(mcc) with I18nSupport {
